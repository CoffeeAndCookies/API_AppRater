...
public class AppRater {
    ...
    public static boolean app_launched(Context context) {
       return  app_launched(context, DAYS_UNTIL_PROMPT, LAUNCHES_UNTIL_PROMPT);
    }
     ...
     */
    public static boolean app_launched(Context context, int daysUntilPrompt, int launchesUntilPrompt) 
    {
